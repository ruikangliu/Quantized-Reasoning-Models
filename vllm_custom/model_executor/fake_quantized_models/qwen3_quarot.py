...
class Qwen3Attention(nn.Module):
    ...
    #     else:
    #         x = (self.had_K.to(x.dtype) @ x.reshape(-1, init_shape[-1]//self.o_had_dim, self.o_had_dim)) / math.sqrt(init_shape[-1]//self.o_had_dim)
...
class Qwen3QuaRotForCausalLM(nn.Module, SupportsLoRA, SupportsPP):
